...
MP4 can improve document-specific geometric reconstruction and processing using these contracts. It should add real model inference only through the model artifact adapter, preserve candidate provenance, and verify classical/model equivalence on governed benchmarks.
